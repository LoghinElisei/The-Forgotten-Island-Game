...
public class LoadingState extends State{
        ...
        new SwingWorker<Void, Void>() {
            ...
            protected Void doInBackground(){
                ...
                try {
                    ...
                    boolean connected = future.get(2, TimeUnit.SECONDS);
    ...
    public void Draw(Graphics2D g2d) {
        ...
        int y = refLink.GetHeight() / 4;

        g2d.setFont(new Font("Cal Sans", Font.BOLD, 50));

        if (isLoading) {
            g2d.drawImage(loadingImage, x + 180, y + 80, refLink.GetWidth() / 17, refLink.GetHeight() / 15, null);
            ...
            g2d.setColor(Color.BLACK);
            g2d.drawString(ld, textX + 3, textY + 3);

            g2d.setColor(Color.WHITE);
            g2d.drawString(ld, textX, textY);

        } else if (errorLoading) {
            g2d.drawImage(loadingImage, x + 180, y + 80, refLink.GetWidth() / 17, refLink.GetHeight() / 15, null);

            String ld = "Connection Failed";
            int textX = x + 20;
            int textY = y + 220;
            ...
            g2d.setColor(Color.decode("#FF4444"));
            g2d.drawString(ld, textX, textY);

            buttons.get(1).draw(g2d, Color.WHITE, Color.WHITE, Color.black);
            buttons.get(2).draw(g2d, Color.WHITE, Color.WHITE, Color.black);
            ...
            g2d.setColor(Color.decode("#39FF14")); // Neon Green
            g2d.drawString(ld, textX, textY);
